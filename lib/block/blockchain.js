...
exports.genAccountTrie = function (txs, stateRoot, cb) {
    ...
    // }
    rootHash = _.isBuffer(stateRoot) ? stateRoot : Buffer.from(stateRoot, 'hex')
    console.log(Buffer.from(stateRoot, 'hex').length)
    return
...
exports.genAccountTrie(transactions, '0xd7f8974fb5ac78d9ac099b9ad5018bedc2ce0a72dad1827a1709da30580f0544', (r) => console.log(r))
